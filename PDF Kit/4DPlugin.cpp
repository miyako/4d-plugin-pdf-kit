...
// --- Page
		...
		case 5 :
			PDF_EXCHANGE_PAGES(pResult, pParams);
			break;
...
// --- Document
		...
		case 11 :
			PDF_Get_ducument_version(pResult, pParams);
			break;
...
{
	C_PICTURE ParamPicture;
	C_BLOB returnValue;
	
	if(!_isTiger()){
		
		ParamPicture.fromParamAtIndex(pParams, 1);
		
		NSImage *pageImage = ParamPicture.copyImage();
